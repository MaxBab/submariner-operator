...
func RunOnAzure(restConfigProducer restconfig.Producer, gwInstanceType string,
	...
	reporter.Started("Retrieving Azure credentials from your Azure authorization file")
